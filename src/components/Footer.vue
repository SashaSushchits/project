  ...
  <footer class="footer">
    <div class="footer__wrapper container">
      <ul class="footer__links">
        ...
        <li>
          <a class="footer__link" href="tel:375291234577"> +375 (29) 123-45-77 </a>
        </li>
        <li>
      ...
      <p class="footer__desc">
        ...
        в&nbsp;соответствии с&nbsp;законодательством&nbsp;РБ, в&nbsp;том числе
      ...
      <span class="footer__copyright"> © 2021 велотовары «спортэк» </span>
    </div>
  </footer>
</template>
